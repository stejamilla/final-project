...
Based on hyperparameter tuning, the best random forest model uses mtry = 15 and min_n = 4. This means it has selected 15 predictors to be randomly sampled when splitting before each tree model and 4 minimum data points needed to do further splits.
