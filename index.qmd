...
landcover |>
  ...
  labs(title = "District of Columbia Census Block Groups, by Ward",
       subtitle = "2020",
       caption = paste0("Source: Census American Community Survey, 2016 - 2022",
                        "\nUrban Tree Canopy by Census Block Group, 2020"),
       fill = "Ward") 
...
### Load Census Demographic Data via API
...
Decide the threshold for hot vs. not hot:
...
## Evaluate Imputation Via Visualization
...
```{r}
#| label: "Evaluate imputation for percent rent burdened variable"
...
```{r}
#| label: "Evaluate imputation for median household income"
...
```{r}
#| label: "Evaluate imputation for median property value"
