...
JAMIE 12/3
I like this idea! That makes sense! Are you thinking we'll use the geometry in the landcover dataset? Or were you thinking of just using the data per block group? Performing st_join to combine acs_data, landcover, and dc_heat produces duplicates in dataset_final, so I added a line of code to drop the geometry from landcover. Not sure if I'm going about this correctly.
