...
# Change the UHI variable from character to numeric
...
# Read in DC land cover data and clean up
...
# Convert block_group to character
...
# remove irrelevant columns that do not contain percentage data
landcover <- landcover |>
  select(-contains("_ac"))
